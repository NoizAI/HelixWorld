...
class Modality:
    ...
    Attributes:
        ...
        video_control: Optional per-token camera/action conditioning. This is
            only consumed by a video-enabled :class:`LTXModel` after
            ``enable_video_controls()`` has been called.
    """
    ...
    def split(self, sizes: list[int]) -> list[Modality]:
        ...
        for f in dataclasses.fields(self):
            ...
            elif isinstance(value, VideoControlCondition):
